    ...
    $.jgrid = $.jgrid || {}, $.jgrid.hasOwnProperty("defaults") || ($.jgrid.defaults = {}), $.extend($.jgrid, {
        ...
        return this.each(function () {
            ...
            if (!this.grid) {
                ...
                var
                    e = this, f = {
                        headers: [], cols: [], footers: [], dragStart: function (a, b, c) {
                            ...
                            if (this.resizing) {
                                var
                                    b, c, e = a.pageX - this.resizing.startX, f = this.headers[this.resizing.idx],
                            ...
                            if (a) {
                                ...
                                if (c) {
                                    f.prevRowHeight = c;
                                    var
                                        h, i, j, k = d.rowNum, l = f.scrollTop = f.bDiv.scrollTop,
                ...
                for (h
                    in
                    $.jgrid.regional) $.jgrid.regional.hasOwnProperty(h) && (0 === k && (g = h), k++);
                ...
                var
                    y = $("<div " + m(n, "entrieBox", !1, "ui-jqgrid") + "></div>");
                $(y).attr({
                    id: "gbox_" + this.id,
                    dir: i
                ...
                var
                    z, A = ["shiftKey", "altKey", "ctrlKey"], B = function (a, b) {
                        ...
                        var
                            a, b, c, d, f, g, h, i, j, k, l, m = e.p, n = m.data, o = n.length, p = m.localReader,
                        ...
                        var
                            f = new
                            Date, g = "local" !== e.p.datatype && e.p.loadonce || "xmlstring" === e.p.datatype, h = "_id_",
                            i = e.p.xmlReader, k = "local" === e.p.datatype ? "local" : "xml";
                        if (g && (e.p.data = [], e.p._index = {}, e.p.localReader.id = h), e.p.reccount = 0, $.isXMLDoc(a)) {
                            ...
                            var
                                l, o, p, q, r, s, t, u, v, w = $(e), x = 0, y = !0 === e.p.multiselect ? 1 : 0, z = 0,
                            ...
                            var
                                M = $.jgrid.getXmlData(a, i.root, !0);
                            M = $.jgrid.getXmlData(M, i.row, !0), M || (M = []);
                            var
                                O, P, Q = M.length, R = 0, S = [], T = parseInt(e.p.rowNum, 10),
                            ...
                            if (e.p.grouping && (W = !0 === e.p.groupingView.groupCollapse, O = $.jgrid.getMethod("groupingPrepare")), Q > 0 && e.p.page <= 0 && (e.p.page = 1), M && Q) {
                                d && (T *= d + 1);
                                for (var
                                         X = $.isFunction(e.p.afterInsertRow), Y = A ? m(n, "rownumBox", !1, "jqgrid-rownum") : "", _ = y ? m(n, "multiBox", !1, "cbox") : ""; R < Q;) {
                                    ...
                                    if (E.push(""), A && E.push(H(0, R, e.p.page, e.p.rowNum, Y)), y && E.push(G(v, A, R, P, _)), z && E.push(q.call(w, y + A, R + b)), i.repeatitems) {
                                        t || (t = J(y + z + A));
                                        var
                                            ba = $.jgrid.getXmlData(u, i.cell, !0);
                                        $.each(t, function (a) {
                                            var
                                                c = ba[this];
                                            if (!c) return !1;
                                        ...
                                        for (l = 0; l < C.length; l++) p = $.jgrid.getXmlData(u, C[l]), D[e.p.colModel[l + y + z + A].name] = p, E.push(F(v, p, l + y + z + A, R + b, u, D));
                            ...
                            Date - f, E = null, x > 0 && 0 === e.p.records && (e.p.records = Q), !0 === e.p.treeGrid) try {
                            ...
                            if (e.p.reccount = x, e.p.treeANode = -1, e.p.userDataOnFooter && w.jqGrid("footerData", "set", e.p.userData, !0), g && (e.p.records = Q, e.p.lastpage = Math.ceil(Q / T)), c || e.updatepager(!1, !0), j && Z(!0), g) {
                                for (; x < Q;) {
                                    if (u = M[x], v = s(u, x + U), v = e.p.idPrefix + v, i.repeatitems) {
                                        t || (t = J(y + z + A));
                                        var
                                            ca = $.jgrid.getXmlData(u, i.cell, !0);
                                        $.each(t, function (a) {
                                            var
                                                b = ca[this];
                                            if (!b) return !1;
                                        ...
                                        for (l = 0; l < C.length; l++) p = $.jgrid.getXmlData(u, C[l]), D[e.p.colModel[l + y + z + A].name] = p;
                        ...
                        if (a) {
                            ...
                            var
                                i, k, l, o, q, r, s, t, u, v, w, x, y, z = "_id_",
                            ...
                            for (A && (e.p.data = [], e.p._index = {}, e.p.localReader.id = z), e.p.reccount = 0, e.p.page = B($.jgrid.getAccessor(a, g.page), e.p.page), e.p.lastpage = B($.jgrid.getAccessor(a, g.total), 1), e.p.records = B($.jgrid.getAccessor(a, g.records)), e.p.userData = $.jgrid.getAccessor(a, g.userdata) || {}, M && (q = $.jgrid.getMethod("addSubGridCell")), v = !1 === e.p.keyName ? $.isFunction(g.id) ? g.id.call(e, a) : g.id : e.p.keyName, g.repeatitems && e.p.keyName && isNaN(v) && (v = e.p.keyIndex), u = $.jgrid.getAccessor(a, g.root), null == u && $.isArray(a) && (u = a), u || (u = []), t = u.length, k = 0, t > 0 && e.p.page <= 0 && (e.p.page = 1), d && (Q *= d + 1), "local" !== e.p.datatype || e.p.deselectAfterSort || (R = !0), e.p.grouping && (_ = !0 === e.p.groupingView.groupCollapse, y = $.jgrid.getMethod("groupingPrepare")); k < t;) {
                                if (o = u[k], void
                                    ...
                                    var
                                        da = $.jgrid.getAccessor(o, g.cell) || o;
                                    x = null != da && void
                            ...
                            if (j = e.p.multiselect && (e.p.preserveSelection || R) && D === j, !0 === e.p.gridview && (w = e.p.treeANode > -1 ? e.p.treeANode : 0, e.p.grouping ? A || (C.jqGrid("groupingRender", Y, e.p.colModel.length, e.p.page, Q), Y = null) : !0 === e.p.treeGrid && w > 0 ? $(e.rows[w]).after(V.join("")) : (aa.append(V.join("")), e.grid.cols = e.rows[0].cells)), e.p.totaltime = new
                            Date - f, V = null, D > 0 && 0 === e.p.records && (e.p.records = t), !0 === e.p.treeGrid) try {
                            ...
                            if (e.p.reccount = D, e.p.treeANode = -1, e.p.userDataOnFooter && C.jqGrid("footerData", "set", e.p.userData, !0), A && (e.p.records = t, e.p.lastpage = Math.ceil(t / Q)), c || e.updatepager(!1, !0), j && Z(!0), A) {
                                for (; D < t && u[D];) {
                                    if (o = u[D], void
                                        ...
                                        var
                                            fa = $.jgrid.getAccessor(o, g.cell) || o;
                                        x = null != fa && void
                        ...
                        if ($.isArray(e.p.data)) {
                            ...
                            var
                                u = s.select(), x = parseInt(e.p.rowNum, 10), y = u.length, z = parseInt(e.p.page, 10),
                                A = Math.ceil(y / x), B = {};
                            if ((e.p.search || e.p.resetsearch) && e.p.grouping && e.p.groupingView._locgr) {
                                ...
                                for (C = 0; C < y; C++) {
                                    if (E) for (D
                                        in
                                        e.p.userData) e.p.userData.hasOwnProperty(D) && (e.p.userData[D] += parseFloat(u[C][D] || 0));
                                    F.call($(e), u[C], C, x)
                                }
                            }
                        ...
                        var
                            c, d, f, g, h, i, j, k, l = "", p = e.p.pager ? $.jgrid.jqID(e.p.pager.substr(1)) : "",
                        ...
                        if (!e.grid.hDiv.loading) {
                            ...
                            j = 0, e.p.page <= 0 && (e.p.page = Math.min(1, e.p.lastpage)), null !== g.search && (f[g.search] = e.p.search), null !== g.nd && (f[g.nd] = (new
                            ...
                            var
                                h = $.isFunction(e.p.loadComplete), i = h ? e.p.loadComplete : null, k = 0;
                            ...
                            var
                                p = e.p.scroll ? e.rows.length - 1 : 1;
                            if ($.isFunction(e.p.datatype)) return void
                                e.p.datatype.call(e, e.p.postData, "load_" + e.p.id, p, a, k);
                            var
                                q = $(e).triggerHandler("jqGridBeforeRequest");
                        ...
                        "ltr" === i && (r += t), r += "</tr></tbody></table>", !0 === e.p.viewrecords && $("td#" + a + "_" + e.p.recordpos, "#" + c).append("<div dir='" + i + "' style='text-align:" + e.p.recordpos + "' class='ui-paging-info'></div>"), $("td#" + a + "_" + e.p.pagerpos, "#" + c).append(r), j = $("#gbox_" + $.jgrid.jqID(e.p.id)).css("font-size") || "11px", $("#gbox_" + $.jgrid.jqID(e.p.id)).append("<div id='testpg' " + m(n, "entrieBox", !1, "ui-jqgrid") + " style='font-size:" + j + ";visibility:hidden;' ></div>"), h = $(r).clone().appendTo("#testpg").width(), $("#testpg").remove(), h > 0 && ("" !== p && (h += 50), $("td#" + a + "_" + e.p.pagerpos, "#" + c).width(h)), e.p._nvtd = [], e.p._nvtd[0] = h ? Math.floor((e.p.width - h) / 2) : Math.floor(e.p.width / 3), e.p._nvtd[1] = 0, r = null, $(".ui-pg-selbox", "#" + c).on("change", function () {
                            ...
                            var
                                a = B(e.p.page, 1), c = B(e.p.lastpage, 1), d = !1, f = !0, g = !0, h = !0, i = !0;
                        ...
                        $("span.ui-grid-ico-sort", g).addClass(o), $(g).attr("aria-selected", "false"), d = f[a].index || f[a].name, void
                            0 === c ? f[a].lso ? "asc" === f[a].lso ? (f[a].lso += "-desc", h = "desc") : "desc" === f[a].lso ? (f[a].lso += "-asc", h = "asc") : "asc-desc" !== f[a].lso && "desc-asc" !== f[a].lso || (f[a].lso = "") : f[a].lso = h = f[a].firstsortorder || "asc" : f[a].lso = h = c, h ? ($("span.s-ico", g).show(), $("span.ui-icon-" + h, g).removeClass(o), $(g).attr("aria-selected", "true")) : e.p.viewsortcols[0] || $("span.s-ico", g).hide();
                        var
                            i = v.indexOf(d);
                        -1 === i ? (v.push(d), w.push(h)) : h ? w[i] = h : (w.splice(i, 1), v.splice(i, 1)), e.p.sortorder = "", e.p.sortname = "";
                        for (var
                                 j = 0, k = v.length; j < k; j++) j > 0 && (e.p.sortname += ", "), e.p.sortname += v[j], j !== k - 1 && (e.p.sortname += " " + w[j]);
                        e.p.sortorder = w[k - 1]
                        ...
                        var
                            a, b, c, d, g = 0, h = $.jgrid.cell_width ? 0 : B(e.p.cellLayout, 0), i = 0,
                        ...
                        var
                            d, f, g = e.p.colModel, h = g.length, i = [], j = $.jgrid.getRegional(e, "colmenu"),
                        ...
                        var
                            f, g, h, i, j, k = e.p.colModel[a], l = "", m = "", n = "", o = "", p = "", r = "",
                        ...
                        var
                            g, h, i = '<ul id="column_menu" role="menu" tabindex="0">', j = "", k = "</ul>", l = "",
                        ...
                        for (var
                            ...
                            var
                                w = e.p.colMenuCustom[v], x = w.exclude.split(",");
                            x = $.map(x, function (a) {
                                return $.trim(a)
                        ...
                        $("#column_menu > li > a").hover(function () {
                            ...
                            var
                                b = $(this).attr("data-value"), c = e.grid.headers[a].el;
                ...
                }), this.p.id = this.id, -1 === $.inArray(e.p.multikey, A) && (e.p.multikey = !1), e.p.keyName = !1, k = 0; k < e.p.colModel.length; k++) z = "string" == typeof
                    e.p.colModel[k].template ? null != $.jgrid.cmTemplate && "object" == typeof
                    $.jgrid.cmTemplate[e.p.colModel[k].template] ? $.jgrid.cmTemplate[e.p.colModel[k].template] : {} : e.p.colModel[k].template, e.p.colModel[k] = $.extend(!0, {}, e.p.cmTemplate, z || {}, e.p.colModel[k]), !1 === e.p.keyName && !0 === e.p.colModel[k].key && (e.p.keyName = e.p.colModel[k].name, e.p.keyIndex = k);
                ...
                var
                    ma, na, oa, pa, qa, ra, sa, ta, ua, va = "<thead><tr class='ui-jqgrid-labels' role='row'>", wa = "",
                    xa = "", ya = "";
                ...
                for (k = 0; k < this.p.colNames.length; k++) {
                    var
                        za = e.p.headertitles ? ' title="' + (e.p.colModel[k].tooltip ? e.p.colModel[k].tooltip : $.jgrid.stripHtml(e.p.colNames[k])) + '"' : "";
                    ua = e.p.colModel[k], ua.hasOwnProperty("colmenu") || (ua.colmenu = "rn" !== ua.name && "cb" !== ua.name && "subgrid" !== ua.name), va += "<th id='" + e.p.id + "_" + ua.name + "' role='columnheader' " + m(n, "headerBox", !1, "ui-th-column ui-th-" + i + ("cb" === ua.name ? " jqgrid-multibox" : "")) + " " + za + ">", na = ua.index || ua.name, va += "<div class='ui-th-div' id='jqgh_" + e.p.id + "_" + ua.name + "' " + ma + ">" + e.p.colNames[k], ua.width ? ua.width = parseInt(ua.width, 10) : ua.width = 150, "boolean" != typeof
                        ua.title && (ua.title = !0), ua.lso = "", na === e.p.sortname && (e.p.lastsort = k), e.p.multiSort && -1 !== (x = $.inArray(na, v)) && (ua.lso = w[x]), va += ta, e.p.colMenu && ua.colmenu && (va += "<a class='" + ("ltr" === e.p.direction ? "colmenu" : "colmenu-rtl") + "'><span class='colmenuspan " + s + " " + t.icon_menu + "'></span></a>"), va += "</div></th>"
                }
                        ...
                        this.checked ? ($(e.rows).each(function (b) {
                            ...
                            if (b > 0 && !($(this).hasClass("ui-subgrid") || $(this).hasClass("jqgroup") || $(this).hasClass(o) || $(this).hasClass("jqfoot"))) {
                                if ($("#jqg_" + $.jgrid.jqID(e.p.id) + "_" + $.jgrid.jqID(this.id))[e.p.useProp ? "prop" : "attr"]("checked", !1), $(this).removeClass(p).attr("aria-selected", "false"), Ba.push(this.id), e.p.preserveSelection) {
                                    var
                                        c = e.p.selarrrow.indexOf(this.id);
                ...
                var
                    Da = "", Ea = -1 === e.p.styleUI.search("Bootstrap") || isNaN(e.p.height) ? 0 : 2;
                ...
                var
                    Fa = $("tr:first", va), Ga = "<tr class='jqgfirstrow' role='row'>";
                if (e.p.disableClick = !1, $("th", Fa).each(function (a) {
                    ua = e.p.colModel[a], oa = ua.width, void
                        0 === ua.resizable && (ua.resizable = !0), ua.resizable ? (pa = document.createElement("span"), $(pa).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-" + i).css("cursor", "col-resize"), $(this).addClass(e.p.resizeclass)) : pa = "", $(this).css("width", oa + "px").prepend(pa), pa = null;
                    var
                        b = "";
                    ...
                    if (1 === f.length) {
                        ...
                        if ($(a.target).hasClass("colmenuspan")) {
                            ...
                            if (-1 === i) return;
                            var
                                j = $(this).position(), k = j.left, l = j.top;
                            return "ltr" === e.p.direction && (k += $(this).outerWidth()), la(i, k, l, f), !0 === e.p.menubar && $("#" + e.p.id + "_menubar").hide(), void
                                a.stopPropagation()
                        }
                ...
                var
                    Ha = $("<table " + m(n, "headerTable", !1, "ui-jqgrid-htable ui-common-table") + " style='width:" + e.p.tblwidth + "px' role='presentation' aria-labelledby='gbox_" + this.id + "'></table>").append(va),
                    Ia = !(!e.p.caption || !0 !== e.p.hiddengrid),
                    Ja = $("<div class='ui-jqgrid-hbox" + ("rtl" === i ? "-rtl" : "") + "'></div>");
                va = null, f.hDiv = document.createElement("div"), f.hDiv.style.width = f.width - Ea + "px", f.hDiv.className = m(n, "headerDiv", !0, "ui-jqgrid-hdiv"), $(f.hDiv).append(Ja), $(Ja).append(Ha), Ha = null, Ia && $(f.hDiv).hide(), e.p.pager && ("string" == typeof
                    e.p.pager ? "#" !== e.p.pager.substr(0, 1) && (e.p.pager = "#" + e.p.pager) : e.p.pager = "#" + $(e.p.pager).attr("id"), $(e.p.pager).css({width: f.width - Ea + "px"}).addClass(m(n, "pagerBox", !0, "ui-jqgrid-pager")).appendTo(y), Ia && $(e.p.pager).hide(), _(e.p.pager, "")), !1 === e.p.cellEdit && !0 === e.p.hoverrows && $(e).on({
                ...
                $(e).before(f.hDiv).on({
                    click: function (a) {
                        ...
                        if ("A" !== qa.tagName && ("INPUT" !== qa.tagName && "TEXTAREA" !== qa.tagName && "OPTION" !== qa.tagName && "SELECT" !== qa.tagName || c)) if (Ka = ra[0].id, qa = $(qa).closest("tr.jqgrow>td"), qa.length > 0 && (La = $.jgrid.getCellIndex(qa)), !0 !== e.p.cellEdit) {
                            if (qa.length > 0 && (Ma = $(qa).closest("td,th").html(), $(e).triggerHandler("jqGridCellSelect", [Ka, La, Ma, a]), $.isFunction(e.p.onCellSelect) && e.p.onCellSelect.call(e, Ka, La, Ma, a)), d) if (e.p.multimail && e.p.multiselect) {
                                if (a.shiftKey) {
                                    if (c) {
                                        var
                                            g = $(e).jqGrid("getGridParam", "selrow"), h = $(e).jqGrid("getInd", Ka),
                                ...
                                e.p.multikey ? a[e.p.multikey] ? $(e).jqGrid("setSelection", Ka, !0, a) : e.p.multiselect && c && (c = $("#jqg_" + $.jgrid.jqID(e.p.id) + "_" + Ka).is(":checked"), $("#jqg_" + $.jgrid.jqID(e.p.id) + "_" + Ka)[e.p.useProp ? "prop" : "attr"]("checked", !c)) : b(Ka, c, a, !0)
                        ...
                        if (qa = a.target, ra = $(qa, e.rows).closest("tr.jqgrow"), 0 !== $(ra).length) {
                            ...
                            var
                                b = $(e).triggerHandler("jqGridDblClickRow", [$(ra).attr("id"), Ka, La, a]);
                            return null != b ? b : $.isFunction(e.p.ondblClickRow) && null != (b = e.p.ondblClickRow.call(e, $(ra).attr("id"), Ka, La, a)) ? b : void
                                0
                        }
                        ...
                        if (qa = a.target, ra = $(qa, e.rows).closest("tr.jqgrow"), 0 !== $(ra).length) {
                            ...
                            var
                                b = $(e).triggerHandler("jqGridRightClickRow", [$(ra).attr("id"), Ka, La, a]);
                            return null != b ? b : $.isFunction(e.p.onRightClickRow) && null != (b = e.p.onRightClickRow.call(e, $(ra).attr("id"), Ka, La, a)) ? b : void
                                0
                        }
                    }
                ...
                var
                    Na = s + " " + m(n, "icon_caption_open", !0), Oa = s + " " + m(n, "icon_caption_close", !0);
                f.cDiv = document.createElement("div");
                var
                    Pa = !0 === e.p.hidegrid ? $("<a role='link' class='ui-jqgrid-titlebar-close HeaderButton " + r + "' title='" + ($.jgrid.getRegional(e, "defaults.showhide", e.p.showhide) || "") + "' />").hover(function () {
                        Pa.addClass(q)
                    }, function () {
                        Pa.removeClass(q)
                ...
                if ($(f.cDiv).append(Pa).append("<span class='ui-jqgrid-title'>" + e.p.caption + "</span>").addClass("ui-jqgrid-titlebar ui-jqgrid-caption" + ("rtl" === i ? "-rtl" : "") + " " + m(n, "gridtitleBox", !0)), !0 === e.p.menubar) {
                    var
                        Qa = '<ul id="' + e.p.id + '_menubar" class="ui-search-menu modal-content column-menu ui-menu jqgrid-caption-menu ' + t.menu_widget + '" role="menubar" tabindex="0"></ul>';
                ...
                if ($(f.cDiv).insertBefore(f.hDiv), e.p.toolbar[0]) {
                    var
                        Ra = m(n, "customtoolbarBox", !0, "ui-userdata");
                ...
                if (e.p.toppager && (e.p.toppager = $.jgrid.jqID(e.p.id) + "_toppager", f.topDiv = $("<div id='" + e.p.toppager + "'></div>")[0], e.p.toppager = "#" + e.p.toppager, $(f.topDiv).addClass(m(n, "toppagerBox", !0, "ui-jqgrid-toppager")).width(f.width - Ea).insertBefore(f.hDiv), _(e.p.toppager, "_t")), e.p.footerrow && (f.sDiv = $("<div class='ui-jqgrid-sdiv'></div>")[0], Ja = $("<div class='ui-jqgrid-hbox" + ("rtl" === i ? "-rtl" : "") + "'></div>"), $(f.sDiv).append(Ja).width(f.width - Ea).insertAfter(f.hDiv), $(Ja).append(Da), f.footers = $(".ui-jqgrid-ftable", f.sDiv)[0].rows[0].cells, e.p.rownumbers && (f.footers[0].className = m(n, "rownumBox", !0, "jqgrid-rownum")), Ia && $(f.sDiv).hide()), Ja = null, e.p.caption) {
                    ...
                    $(f.cDiv).hide(), e.p.toppager || $(f.hDiv).addClass(m(e.p.styleUI + ".common", "cornertop", !0));
                if ($(f.hDiv).after(f.bDiv).mousemove(function (a) {
                    ...
                    var
                        Ta = "onorientationchange" in
                            window, Ua = Ta ? "orientationchange" : "resize";
        ...
        getGridParam: function (a, b) {
            ...
            return this.each(function () {
                ...
                if (i.grid && (isNaN(b) ? $(i.p.colModel).each(function (a) {
                    ...
                    if (k) {
                        ...
                        if (l) {
                            if ("" !== c || !0 === f) {
                                if ("local" === i.p.datatype) n = $(i).jqGrid("getLocalRow", a); else if (void
                                    0 !== k.cells) for (; m < k.cells.length;) g = $.unformat.call(i, $(k.cells[m]), {
                                    rowId: k.id,
                    ...
                    if (!0 !== a.p.subGrid && !0 !== a.p.treeGrid && !0 !== a.p.cellEdit && !a.p.scroll) {
                        ...
                        if (e >= 0 && f) {
                            ...
                            $(a).on("jqGridResizeStop.setFrozenColumns", function (b, c, d) {
                                var
                                    e = i ? "outerWidth" : "width", f = $(".ui-jqgrid-htable", a.grid.fhDiv),
            ...
            var
                c = this[0].p.styleUI, d = $.jgrid.styleUI[c].colmenu;
            return b = $.extend({
                title: "Item",
            ...
            var
                b, c, d = this[0].p.styleUI, e = $.jgrid.styleUI[d].common;
            return this.each(function () {
                var
                    d = this;
                if ($.isArray(a)) for (var
                                           f = 0; f < a.length; f++) {
        ...
        NumberFormat: function (b, c) {
            if (a.fmatter.isNumber(b) || (b *= 1), a.fmatter.isNumber(b)) {
                ...
                if (a.fmatter.isNumber(c.decimalPlaces)) {
                    var
                        h = c.decimalPlaces;
                    if (f = String(Number(Math.round(b + "e" + h) + "e-" + h)), d = f.lastIndexOf("."), h > 0) for (d < 0 ? (f += g, d = f.length - 1) : "." !== g && (f = f.replace(".", g)); f.length - 1 - d < h;) f += "0"
                }
                if (c.thousandsSeparator) {
                    var
                        i = c.thousandsSeparator;
                    d = f.lastIndexOf(g), d = d > -1 ? d : f.length;
                    var
                        j, k = f.substring(d), l = -1;
                    for (j = d; j > 0; j--) l++, l % 3 == 0 && j !== d && (!e || j > 1) && (k = i + k), k = f.charAt(j - 1) + k;
                    f = k
                }
...
!function (a) {
    ...
    a.extend(a.jgrid, {
        showModal: function (a) {
            ...
            var
                i = this, j = "rtl" === a(d.gbox).attr("dir"), k = a.jgrid.styleUI[d.styleUI || "jQueryUI"].modal,
                l = a.jgrid.styleUI[d.styleUI || "jQueryUI"].common, m = document.createElement("div");
            ...
            a.jgrid.createModal({
                ...
                scrollelm: "infocnt"
            }, o, f, "", "", !0, {"font-size": p}), l && a.each(f.buttons, function (b) {
            ...
            switch (b) {
                case"textarea":
                    h = document.createElement("textarea"), e ? c.cols || a(h).css({width: "98%"}) : c.cols || (c.cols = 20), c.rows || (c.rows = 2), ("&nbsp;" === d || "&#160;" === d || 1 === d.length && 160 === d.charCodeAt(0)) && (d = ""), h.value = d, a(h).attr({
                        role: "textbox",
                        multiline: "true"
                    }), g(h, c);
                    break;
                        ...
                        i.p && i.p.idPrefix && (n = a.jgrid.stripPref(i.p.idPrefix, n)), a.ajax(a.extend({
                            ...
                            success: function (b) {
                                var
                                    ...
                                    j = !0 === h.multiple, k = !0 === h.cacheUrlData, l = "",
                ...
                default:
                    var
                        B;
                    B = "button" === b ? "button" : "textbox", h = document.createElement("input"), h.type = b, h.value = d, "button" !== b && (e ? c.size || a(h).css({width: "96%"}) : c.size || (c.size = 20)), a(h).attr("role", B), g(h, c)
            }
            return h
            ...
            var
                c, d, e = !0;
            for (c = 0; c < b.elements.length; c++) if (d = b.elements[c], ("INPUT" === d.nodeName || "TEXTAREA" === d.nodeName || "SELECT" === d.nodeName) && (void
            ...
            var
                b = !0, c = a.value, d = a.getAttribute("type"), e = "checkbox" === d || "radio" === d,
                f = a.getAttribute("required"), g = a.getAttribute("minlength"), h = a.getAttribute("maxlength"),
                i = a.getAttribute("pattern");
            return a.disabled ? b : (b = b && (!f || e && a.checked || !e && "" !== c), b = b && (e || (!g || c.length >= g) && (!h || c.length <= h)), b && i && (i = new
    ...
    a.jgrid.extend({
        editGridRow: function (c, d) {
            ...
            return d = a.extend(!0, {
                ...
                f(c, d, e, f) {
                    ...
                    if ("_empty" !== c && (r = a(d).jqGrid("getInd", c)), a(d.p.colModel).each(function (n) {
                        if (h = this.name, i = (!this.editrules || !0 !== this.editrules.edithidden) && !0 === this.hidden, l = i ? "style='display:none'" : "", "cb" !== h && "subgrid" !== h && !0 === this.editable && "rn" !== h) {
                            ...
                            var
                                t = a.extend({}, this.editoptions || {}, {id: h, name: h, rowId: c, oper: "edit"}),
                                v = a.extend({}, {
                                    elmprefix: "",
                                    elmsuffix: "",
                                    rowabove: !1,
                                    rowcontent: ""
                                }, this.formoptions || {}), w = parseInt(v.rowpos, 10) || p + 1,
                ...
                if (s.grid && c) {
                    ...
                    if (F ? (I = q(b[a(this)[0].p.id].template), t = A) : (I = a("<table id='" + z + "' class='EditTable ui-common-table'><tbody></tbody></table>"), t = A + "_2"), y = "#" + a.jgrid.jqID(y), a(L).append("<div class='FormError " + h.error + "' style='display:none;'></div>"), a(L).append("<div class='tinfo topinfo'>" + b[s.p.id].topinfo + "</div>"), a(s.p.colModel).each(function () {
                        ...
                        n(), f(c, s, I, D);
                        var
                            M = "rtl" === s.p.direction, N = M ? "nData" : "pData", O = M ? "pData" : "nData",
                        ...
                        var
                            Y = a(".ui-jqgrid").css("font-size") || "11px";
                        if (a.jgrid.createModal(B, X, b[a(this)[0].p.id], "#gview_" + a.jgrid.jqID(s.p.id), a("#gbox_" + a.jgrid.jqID(s.p.id))[0], null, {"font-size": Y}), M && (a("#pData, #nData", A + "_2").css("float", "right"), a(".EditButton", A + "_2").css("text-align", "left")), b[s.p.id].topinfo && a(".tinfo", y).show(), b[s.p.id].bottominfo && a(".binfo", y).show(), X = null, U = null, a("#" + a.jgrid.jqID(B.themodal)).keydown(function (c) {
                            var
                                e = c.target;
            ...
            return d = a.extend(!0, {
                ...
                if (l.grid && c) {
                    ...
                    if (a(l.p.colModel).each(function () {
                        ...
                        f(c, l, y, t);
                        var
                            z = "rtl" === l.p.direction, A = z ? "nData" : "pData", B = z ? "pData" : "nData",
                        ...
                        a.jgrid.createModal(r, H, b[a(this)[0].p.id], "#gview_" + a.jgrid.jqID(l.p.id), a("#gview_" + a.jgrid.jqID(l.p.id))[0], null, {"font-size": I}), z && (a("#pData, #nData", "#" + o + "_2").css("float", "right"), a(".EditButton", "#" + o + "_2").css("text-align", "left")), d.viewPagerButtons || a("#pData, #nData", "#" + o + "_2").hide(), H = null, a("#" + r.themodal).keydown(function (c) {
            ...
            return d = a.extend(!0, {
                ...
                if (e.grid && c) {
                    var
                        f, i, j, k, l = e.p.id, m = {}, n = !0, o = "DelTbl_" + a.jgrid.jqID(l), p = "DelTbl_" + l,
                        q = {themodal: "delmod" + l, modalhead: "delhd" + l, modalcontent: "delcnt" + l, scrollelm: o};
                    if (b[e.p.id].styleUI = e.p.styleUI || "jQueryUI", a.isArray(c) && (c = c.join()), void
                        ...
                        if (t += "<table class='EditTable ui-common-table' id='" + o + "_2'><tbody><tr><td><hr class='" + h.content + "' style='margin:1px'/></td></tr><tr><td class='DelButton EditButton'>" + w + "</td></tr></tbody></table>", d.gbox = "#gbox_" + a.jgrid.jqID(l), a.jgrid.createModal(q, t, b[e.p.id], "#gview_" + a.jgrid.jqID(e.p.id), a("#gview_" + a.jgrid.jqID(e.p.id))[0], null, {"font-size": x}), a(".fm-button", "#" + o + "_2").hover(function () {
                            a(this).addClass(h.hover)
                        }, function () {
                            a(this).removeClass(h.hover)
                    ...
                    if (p.grid && "string" == typeof
                        ...
                        if (a(p).data("navGrid") || a(p).data("navGrid", c), n = a(p).data("navGrid"), p.p.force_regional && (n = a.extend(n, i)), void
                            ...
                            a.jgrid.createModal(o, "<div>" + n.alerttext + "</div><span tabindex='0'><span tabindex='-1' id='jqg_alrt'></span></span>", {
                                ...
                                styleUI: p.p.styleUI
                            }, "#gview_" + a.jgrid.jqID(p.p.id), a("#gbox_" + a.jgrid.jqID(p.p.id))[0], !0, {"font-size": q})
                        }
                        var
                            r, s = 1, t = function () {
            ...
            return this.each(function () {
                ...
                (function () {
                    var
                        b, k, l = a(".ui-jqgrid").css("font-size") || "11px",
    ...
    a.fn.jqFilter = function (b) {
                ...
                if (this.p.initFilter = a.extend(!0, {}, this.p.filter), d) {
                    ...
                    this.onchange = function () {
                        ...
                        if (k.append(l), !0 === this.p.ruleButtons) {
                            var
                                m = a("<select size='1' class='opsel " + i.srSelect + "'></select>");
                            l.append(m);
                            var
                                n, o = "";
                        ...
                        p.append(r);
                        var
                            s, t = a("<select size='1' class='" + i.srSelect + "'></select>"), u = [];
                        ...
                        var
                            A = a("<select size='1' class='selectopts " + i.srSelect + "'></select>");
        ...
        filterToolbar: function (b) {
                ...
                if (!d.p.filterToolbar) {
                    ...
                    var
                        ...
                        j = a.jgrid.styleUI[d.p.styleUI || "jQueryUI"].base, k = function () {
                            var
                                c, e, f, g, h = {}, i = 0, j = {}, k = !1, l = [], m = !1, n = [!0, "", ""], o = !1;
                            if (a.each(d.p.colModel, function () {
                                ...
                                if (!0 === b.stringResult || "local" === d.p.datatype || !0 === b.searchOperators) {
                                    var
                                        q = '{"groupOp":"' + b.groupOp + '","rules":[', r = 0;
                                    a.each(h, function (a, b) {
                                        r > 0 && (q += ","), q += '{"field":"' + a + '",', q += '"op":"' + j[a] + '",', b += "", q += '"data":"' + b.replace(/\\/g, "\\\\").replace(/\"/g, '\\"') + '"}', r++
                                    }), q += "]}";
                                    var
                                        s, t, u, v, w, x, y;
                                    if (k && (s = a.jgrid.filterRefactor({
                                        ruleGroup: q,
                                        ssfield: l,
                                        splitSelect: b.splitSelect,
                                        groupOpSelect: b.groupOpSelect
                                    }), q = JSON.stringify(s)), m && (a.isPlainObject(s) || (s = a.jgrid.parse(q)), s.rules && s.rules.length)) for (t = s.rules, u = 0; u < t.length; u++) w = t[u], "bt" === w.op && (x = w.data.split("..."), x.length > 1 && (void
                                        ...
                                        var
                                            b = 0 === a ? "ge" : "le";
                                        (v = x[a]) && y.rules.push({data: x[a], op: b, field: w.field})
                                    }), t.splice(u, 1), u--));
                                    (m || k) && (q = JSON.stringify(s)), a.extend(d.p.postData, {filters: q}), a.each(["searchField", "searchString", "searchOper"], function (a, b) {
                                ...
                                var
                                    z;
                                b.url && (z = d.p.url, a(d).jqGrid("setGridParam", {url: b.url}));
                                var
                                    A = "stop" === a(d).triggerHandler("jqGridToolbarBeforeSearch");
                                !A && a.isFunction(b.beforeSearch) && (A = b.beforeSearch.call(d)), A || a(d).jqGrid("setGridParam", {search: p}).trigger("reloadGrid", [{page: 1}]), z && a(d).jqGrid("setGridParam", {url: z}), a(d).triggerHandler("jqGridToolbarAfterSearch"), a.isFunction(b.afterSearch) && b.afterSearch.call(d)
                            } else if (a.isFunction(o)) o.call(d, n[1]); else {
                                var
                                    B = a.jgrid.getRegional(d, "errors");
                                a.jgrid.info_dialog(B.errcap, n[1], "", {styleUI: d.p.styleUI})
                            }
                        }, l = function (c) {
                            var
                                e, f = {}, g = 0;
                            ...
                            for (var
                                     g, j, l = a(".ui-jqgrid").css("font-size") || "11px", m = '<ul id="sopt_menu" class="ui-search-menu modal-content" role="menu" tabindex="0" style="font-size:' + l + ";left:" + e + "px;top:" + f + 'px;">', n = a(c).attr("soper"), o = [], p = 0, q = a(c).attr("colname"), r = d.p.colModel.length; p < r && d.p.colModel[p].name !== q;) p++;
                            var
            ...
            return b = a.extend(!0, {filters: "", onClearVal: null, onSetVal: null}, b || {}), this.each(function () {
                ...
                c(g) {
                    if (g && g.rules) {
                        for (h = g.rules, m = h.length, d = 0; d < m; d++) if (i = h[d], -1 !== (j = a.inArray(i.field, n)) && (f = a("#gs_" + k.p.idPrefix + a.jgrid.jqID(l[j].name)), f.length > 0 && ("select" === l[j].stype ? f.find("option[value='" + a.jgrid.jqID(i.data) + "']").prop("selected", !0) : "text" === l[j].stype && f.val(i.data), a.isFunction(b.onSetVal) && b.onSetVal.call(k, f, l[j].name), e && e.searchOperators))) {
                            var
                                o = f.parent().prev();
                            o.hasClass("ui-search-oper") && (a(".soptclass", o).attr("soper", i.op), e.operands.hasOwnProperty(i.op) && a(".soptclass", o).html(e.operands[i.op]))
                        }
                        if (g.groups) for (var
                ...
                var
                    d, e, f, g, h, i, j, k = this, l = k.p.colModel, m = k.p.colModel.length, n = [];
                if (k.p.filterToolbar) {
                    for (e = a(k).data("filterToolbar"), d = 0; d < m; d++) {
                        switch (n.push(l[d].name), f = a("#gs_" + k.p.idPrefix + a.jgrid.jqID(l[d].name)), l[d].stype) {
                            case"select":
                            case"text":
                                f.val("")
                        }
                        a.isFunction(b.onClearVal) && b.onClearVal.call(k, f, l[d].name)
                    }
                    "string" == typeof
            ...
            return b = a.extend(!0, {
                ...
                if (d.grid) {
                    ...
                    if (b.styleUI = d.p.styleUI, "string" == typeof
                        ...
                        var
                            C = a(".ui-jqgrid").css("font-size") || "11px";
                        b.layer ? a.jgrid.createModal(i, m, b, "#gview_" + a.jgrid.jqID(d.p.id), a("#gbox_" + a.jgrid.jqID(d.p.id))[0], "string" == typeof
                            ...
                            position: "relative",
                            "font-size": C
                        } : {"font-size": C}) : a.jgrid.createModal(i, m, b, "#gview_" + a.jgrid.jqID(d.p.id), a("#gbox_" + a.jgrid.jqID(d.p.id))[0], null, {"font-size": C}), (b.searchOnEnter || b.closeOnEscape) && a("#" + a.jgrid.jqID(i.themodal)).keydown(function (c) {
                            var
                                d = a(c.target);
...
!function (a) {
    ...
    a.jgrid.extend({
        editCell: function (b, c, d, e) {
            return this.each(function () {
                var
                    f, g, h, i, j = this, k = a(this).jqGrid("getStyleUI", j.p.styleUI + ".common", "highlight", !0),
                ...
                if (j.grid && !0 === j.p.cellEdit) {
                    ...
                    if (i = j.p.colModel[c], "subgrid" !== (f = i.name) && "cb" !== f && "rn" !== f) {
                        ...
                        if (h.addClass("edit-cell " + k), a(j.rows[b]).addClass("selected-row " + l), !0 !== i.editable || !0 !== d || h.hasClass("not-editable-cell") || a.isFunction(j.p.isCellEditable) && !j.p.isCellEditable.call(j, f, b, c)) g = h.html().replace(/\&#160\;/gi, ""), a(j).triggerHandler("jqGridCellSelect", [j.rows[b].id, c, g, e]), a.isFunction(j.p.onCellSelect) && j.p.onCellSelect.call(j, j.rows[b].id, c, g, e); else {
                            try {
                                g = a.unformat.call(j, h, {rowId: j.rows[b].id, colModel: i}, c)
                            } catch (a) {
                            ...
                            a.inArray(i.edittype, ["text", "textarea", "password", "select"]) > -1 && a(q).addClass(m), h.html("").append(q).attr("tabindex", "0"), a.jgrid.bindEv.call(j, q, p), window.setTimeout(function () {
                                ...
                                if (9 === d.keyCode) {
                                    ...
                                    if (d.shiftKey) {
                                        !a(j).jqGrid("prevCell", b, c, d) && j.p.editNextRowCell && b - 1 > 0 && j.rows[b - 1] && (b--, a(j).jqGrid("prevCell", b, j.p.colModel.length, d))
                                    } else {
                                        !a(j).jqGrid("nextCell", b, c, d) && j.p.editNextRowCell && j.rows[b + 1] && (b++, a(j).jqGrid("nextCell", b, 0, d))
                                    }
                                }
                                d.stopPropagation()
            ...
            return this.each(function () {
                var
                    d = this, e = d.p.savedRow.length >= 1 ? 0 : null, f = a.jgrid.getRegional(this, "errors"),
                    g = a.jgrid.getRegional(this, "edit");
                if (d.grid && !0 === d.p.cellEdit) {
                    if (null !== e) {
                        var
                            h, i, j = a(d).jqGrid("getGridRowById", d.p.savedRow[0].rowId),
                            k = a("td:eq(" + c + ")", j), l = d.p.colModel[c], m = l.name, n = a.jgrid.jqID(m),
                            o = a(k).offset();
                        switch (l.edittype) {
                            case"select":
                            ...
                            case"custom":
                                try {
                                    ...
                                    if (void
                                        0 === (h = l.editoptions.custom_value.call(d, a(".customelement", k), "get"))) throw"e2";
                                    i = h
                                } catch (b) {
                                    "e1" === b ? a.jgrid.info_dialog(f.errcap, "function 'custom_value' " + g.msg.nodefined, g.bClose, {styleUI: d.p.styleUI}) : "e2" === b ? a.jgrid.info_dialog(f.errcap, "function 'custom_value' " + g.msg.novalue, g.bClose, {styleUI: d.p.styleUI}) : a.jgrid.info_dialog(f.errcap, b.message, g.bClose, {styleUI: d.p.styleUI})
                                }
                        }
                        if (i !== d.p.savedRow[e].v) {
                            ...
                            var
                                u = a.jgrid.checkValues.call(d, h, c), v = !1;
                            if (!0 === u[0]) {
                                var
                                ...
                                if (a("input.hasDatepicker", k).length > 0 && a("input.hasDatepicker", k).datepicker("hide"), "remote" === d.p.cellsubmit) if (d.p.cellurl) {
                                    var
                                        y = {};
                                    d.p.autoencode && (h = a.jgrid.htmlEncode(h)), l.editoptions && l.editoptions.NullIfEmpty && "" === h && (h = "null", v = !0), y[m] = h;
                                    var
                                        z = d.p.prmNames, A = z.id, B = z.oper;
                                    ...
                                    try {
                                        a.jgrid.info_dialog(f.errcap, f.nourl, g.bClose, {styleUI: d.p.styleUI}), d.p.restoreCellonFail && a(d).jqGrid("restoreCell", b, c)
                                    } catch (a) {
                                    }
            ...
            return this.each(function () {
                var
                    d = this, e = d.p.savedRow.length >= 1 ? 0 : null;
                if (d.grid && !0 === d.p.cellEdit) {
                    if (null !== e) {
                        var
                            f = a(d).jqGrid("getGridRowById", d.p.savedRow[e].rowId), g = a("td:eq(" + c + ")", f);
                        if (a.isFunction(a.fn.datepicker)) try {
            ...
            return this.each(function () {
                ...
                if (g.grid && !0 === g.p.cellEdit) {
                    for (f = c + 1; f < g.p.colModel.length; f++) if (!0 === g.p.colModel[f].editable && (!a.isFunction(g.p.isCellEditable) || g.p.isCellEditable.call(g, g.p.colModel[f].name, b, f))) {
                        h = f;
                        break
                    }
                    !1 !== h ? (e = !0, a(g).jqGrid("editCell", b, h, !0, d)) : (e = !1, g.p.savedRow.length > 0 && a(g).jqGrid("saveCell", b, c))
                }
            }), e
            ...
            return this.each(function () {
                var
                    f, g = this, h = !1;
                if (!g.grid || !0 !== g.p.cellEdit) return !1;
                for (f = c - 1; f >= 0; f--) if (!0 === g.p.colModel[f].editable && (!a.isFunction(g.p.isCellEditable) || g.p.isCellEditable.call(g, g.p.colModel[f].name, b, f))) {
                    h = f;
                    break
                }
                !1 !== h ? (e = !0, a(g).jqGrid("editCell", b, h, !0, d)) : (e = !1, g.p.savedRow.length > 0 && a(g).jqGrid("saveCell", b, c))
        ...
        setSubGrid: function () {
            ...
            return this.each(function () {
                ...
                if (d.grid) {
                        ...
                        k = a.jgrid.styleUI[d.p.styleUI || "jQueryUI"].common, l = function (b, c, e) {
                            ...
                            a(h).append(i), b && (g = d.p.xmlReader.subgrid, a(g.root + " " + g.row, b).each(function () {
                                if (i = a("<tr class='" + k.content + " ui-subtblcell'></tr>"), !0 === g.repeatitems) a(g.cell, this).each(function (b) {
                                    ...
                                    if (b) for (f = 0; f < b.length; f++) l(i, a.jgrid.getXmlData(this, b[f]) || "&#160;", f)
                                }
                                a(h).append(i)
                            }));
                            var
                            ...
                            if (a(n).append(o), b && (i = d.p.jsonReader.subgrid, void
                                ...
                                if (h = f[g], o = a("<tr class='" + k.content + " ui-subtblcell'></tr>"), !0 === i.repeatitems) for (i.cell && (h = h[i.cell]), m = 0; m < h.length; m++) l(o, h[m] || "&#160;", m); else {
                                    ...
                                    if (p.length) for (m = 0; m < p.length; m++) l(o, a.jgrid.getAccessor(h, p[m]) || "&#160;", m)
                                }
                                a(n).append(o)
                            }
                            var
                    ...
                    if (!0 === d.p.subGridOptions.expandOnLoad) {
                        var
                            u = 0;
                        d.p.multiselect && u++, d.p.rownumbers && u++, a(d.rows).filter(".jqgrow").each(function (b, c) {
                            a(c.cells[u]).click()
                        })
                    }
    ...
    a.jgrid.extend({
        groupingSetup: function () {
            ...
            return this.each(function () {
                ...
                var
                    g, h, i, j = e.join("_"), k = d.minusicon, l = d.plusicon, m = a("#" + a.jgrid.jqID(b)),
                    n = m.length ? m[0].nextSibling : null,
                    o = a("#" + a.jgrid.jqID(b) + " span.tree-wrap-" + c.p.direction), p = function (b) {
                        var
                        ...
                        return c.length > 0 ? c[0] : void
                            0
                    }, q = !1, r = !1, s = !!c.p.frozenColumns && c.p.id + "_frozen",
            ...
            return this.each(function () {
                ...
                g(b, d, e, g, h) {
                    var
                        i, j, l, m, n = f(b, d, e), o = k.p.colModel, p = n.cnt, q = "", r = !1;
                    for (j = g; j < c; j++) o[j].hidden ? l = "<td " + k.formatCol(j, 1, "") + ">&#160;</td>" : !r && h ? (l = h, r = !0) : l = "<td " + k.formatCol(j, 1, "") + ">&#160;</td>", a.each(n.summary, function () {
                        if (this.nm === o[j].name) {
                            m = o[j].summaryTpl ? o[j].summaryTpl : "{0}", "string" == typeof
                                this.st && "avg" === this.st.toLowerCase() && (this.sd && this.vd ? this.v = this.v / this.vd : this.v && p > 0 && (this.v = this.v / p));
                            try {
        ...
        setTreeNode: function (b, c) {
            ...
            this.each(function () {
                ...
                if (c.grid && c.p.treeGrid) {
                    var
                        e = a(c).jqGrid("getNodeChildren", b), f = c.p.treeReader.expanded_field,
                        g = b[c.p.localReader.id], h = a(c).triggerHandler("jqGridBeforeExpandTreeGridRow", [g, b, e]);
                    void
            ...
            return this.each(function () {
                if (this.grid && this.p.treeGrid) {
                    var
                        c = this, d = this.p.treeReader.expanded_field, e = this.p.treeReader.parent_id_field,
    ...
    a.assocArraySize = function (a) {
        ...
        pivotSetup: function (c, d) {
            ...
            return this.each(function () {
                function
                f(b) {
                    a.isFunction(c.onInitPivot) && c.onInitPivot.call(g), a.isArray(b) || (b = []);
                    var
                        e, f, h, i, j = jQuery(g).jqGrid("pivotSetup", b, c), k = a.assocArraySize(j.summary) > 0,
                    ...
                    c.frozenStaticCols && jQuery(g).jqGrid("setFrozenColumns"), a.isFunction(c.onCompletePivot) && c.onCompletePivot.call(g), c.loadMsg && a(".loading_pivot").remove()
                }

                var
                    g = this, h = d.regional ? d.regional : "en";
                void
...
!function (a) {
    ...
    a.jgrid = a.jgrid || {}, a.extend(a.jgrid, {
        ...
        jqGridExport: function (b) {
            b = a.extend({exptype: "xmlstring", root: "grid", ident: "\t", addOptions: {}, data: !0}, b || {});
            var
                c = null;
            return this.each(function () {
                if (this.grid) {
    ...
    a.jgrid = a.jgrid || {}, a.extend(a.jgrid, {
        formatCell: function (b, c, d, e, f, g) {
            ...
            if (void
                0 !== e.formatter) {
                var
                    i = {rowId: "", colModel: e, gid: f.p.id, pos: c, styleUI: "", isExported: !0, exporttype: g};
        ...
        exportToCsv: function (b) {
            ...
            if (this.each(function () {
                ...
                d(b, c) {
                    ...
                    var
                        f = "", g = j.p.groupingView, h = [], i = g.groupField.length, m = j.p.colModel, n = m.length,
                        o = 0;
                    ...
                    return a.each(g.groups, function (d, k) {
                        ...
                        var
                            n;
                        if (n = "header" === g.groupSummaryPos[k.idx] ? e(d, 0, g.groups, 0) : new
                        Array(c.collen), n[0] = a.jgrid.formatCellCsv(a.jgrid.stripHtml(l), c), f += n.join(c.separator) + c.newLine, i - 1 === k.idx) {
                            var
                                s, t, u, v = g.groups[d + 1], w = 0, x = k.startRow, y = void
                                    0 !== v ? v.startRow : g.groups[d].startRow + g.groups[d].cnt;
                            for (s = x; s < y && b[s - w]; s++) {
                                for (u = b[s - w], q = 0, t = 0; t < m.length; t++) m[t]._expcol && (n[q] = a.jgrid.formatCellCsv(a.jgrid.formatCell(u[m[t].name], t, u, m[t], j, "csv"), c), q++);
                ...
                RegExp(b.quote, "g");
                var
                    e, f, g, h, i, j = this, k = this.addLocalData(!0), l = k.length, m = j.p.colModel, n = m.length,
                    o = j.p.colNames, p = 0, q = "", r = "", s = "", t = "", u = "", v = [], w = [];
                if (a.each(m, function (c, d) {
                    d._expcol = !0, void
                        0 === d.exportcol ? d.hidden && (d._expcol = !1) : d._expcol = d.exportcol, "cb" !== d.name && "rn" !== d.name && "subgrid" !== d.name || (d._expcol = !1), d._expcol && (v.push(a.jgrid.formatCellCsv(o[c], b)), w.push(d.name))
                }), b.includeLabels && (u = v.join(b.separator) + b.newLine), b.collen = v.length, j.p.grouping) {
                    var
                        x = !!j.p.groupingView._locgr;
                    j.p.groupingView._locgr = !1, q += d(k, b), j.p.groupingView._locgr = x
                } else
                    for (; p < l;) {
                        for (f = k[p], g = [], h = 0, e = 0; e < n; e++) m[e]._expcol && (g[h] = a.jgrid.formatCellCsv(a.jgrid.formatCell(f[m[e].name], e, f, m[e], j, "csv"), b), h++);
            ...
            b = a.extend(!0, {
                ...
                var
                    e, f, g = this, h = a.jgrid.excelStrings, i = 0, j = a.parseXML(h["xl/worksheets/sheet1.xml"]),
                    k = j.getElementsByTagName("sheetData")[0], l = {
                ...
                for (e = 0, f = m.length; e < f; e++) m[e]._expcol = !0, void
                    0 === m[e].exportcol ? m[e].hidden && (m[e]._expcol = !1) : m[e]._expcol = m[e].exportcol, "cb" !== m[e].name && "rn" !== m[e].name && "subgrid" !== m[e].name && m[e]._expcol && (o.header[n] = m[e].name, o.width[n] = 5, o.map[n] = e, n++);
                var
                    p, q, r = a.isFunction(b.replaceStr) ? b.replaceStr : c, s = function (c, d) {
                        ...
                        for (var
                            ...
                            if (!h) {
                                if ("number" == typeof
                                    s && s.toString().length <= e || l && l[1].length + (l[2] ? l[3].length : 0) <= e) h = a.jgrid.makeNode(j, "c", {
                                    attr: {
                                        t: "n",
                                        r: n
                                    }, children: [a.jgrid.makeNode(j, "v", {text: s})]
                                    ...
                                    h = a.jgrid.makeNode(j, "c", {
                                        ...
                                        children: {row: a.jgrid.makeNode(j, "is", {children: {row: a.jgrid.makeNode(j, "t", {text: w})}})}
                                    })
                                }
                                q.appendChild(h)
                            }
                ...
                if (b.includeLabels && (s(o.header, !0), a("row:last c", j).attr("s", "2")), g.p.grouping) {
                    var
                        E = !!g.p.groupingView._locgr;
                    g.p.groupingView._locgr = !1, d(o.body), g.p.groupingView._locgr = E
                } else
                    for (var
                             F = 0, G = o.body.length; F < G; F++) s(o.body[F], !1);
                ...
                a.isFunction(b.onBeforeExport) && b.onBeforeExport(l, i), o = null;
                try {
                    var
                        I = new
                        JSZip, J = {type: "blob", mimeType: b.mimetype};
                    a.jgrid.xmlToZip(I, l), I.generateAsync ? I.generateAsync(J).then(function (c) {
                        a.jgrid.saveAs(c, b.fileName, {type: b.mimetype})
                    }) : a.jgrid.saveAs(I.generate(J), b.fileName, {type: b.mimetype})
                } catch (a) {
                    throw a
                }
            })
            ...
            return b = a.extend(!0, {
                ...
                var
                    d, e, f, g, h = this, i = [], j = h.p.colModel, k = {}, l = h.addLocalData(!0), m = [], n = 0,
                    o = [], p = [], q = [], r = {};
                for (d = 0, e = j.length; d < e; d++) j[d]._expcol = !0, void
                    0 === j[d].exportcol ? j[d].hidden && (j[d]._expcol = !1) : j[d]._expcol = j[d].exportcol, "cb" !== j[d].name && "rn" !== j[d].name && "subgrid" !== j[d].name && j[d]._expcol && (k = {
                    text: h.p.colNames[d],
                    style: "tableHeader"
            ...
            return this.each(function () {
                ...
                d(b) {
                    ...
                    d(b, d, f, i) {
                        var
                            k, m, n = c(b, d, f), o = n.cnt, p = e(j.header);
                        for (m = i; m < l; m++) if (h[m]._expcol) {
                            var
                                q = "{0}";
                    ...
                    var
                        f = g.p.groupingView, i = [], k = f.groupField.length, l = h.length, m = 0, n = "";
                    a.each(h, function (a, b) {
                        var
                            c;
                        for (c = 0; c < k; c++) if (f.groupField[c] === b.name) {
                            i[c] = a;
                            break
                        }
                    });
                    ...
                    return a.each(f.groups, function (c, h) {
                        ...
                        var
                            r, s = !1;
                        if ("header" === f.groupSummaryPos[h.idx] ? r = d(c, 0, f.groups, 0) : (r = e(j.header), s = !0), r[Object.keys(r)[0]] = new
                ...
                var
                    e, f, g = this, h = g.p.colModel, i = 0,
                    j = {body: g.addLocalData(!0), header: [], footer: [], width: [], map: [], align: []};
                for (e = 0, f = h.length; e < f; e++) h[e]._expcol = !0, void
                    0 === h[e].exportcol ? h[e].hidden && (h[e]._expcol = !1) : h[e]._expcol = h[e].exportcol, "cb" !== h[e].name && "rn" !== h[e].name && "subgrid" !== h[e].name && h[e]._expcol && (j.header[i] = h[e].name, j.width[i] = h[e].width, j.map[i] = e, j.align[i] = h[e].align || "left", i++);
                var
                    k = document.createElement("a"), l = function (b) {
                        ...
                        for (var
                                 d, e = "<tr>", f = 0, h = a.length; f < h; f++) d = !0 === c ? " style=width:" + j.width[f] + "px;" : "", e += "<" + b + d + ">" + g.p.colNames[j.map[f]] + "</" + b + ">";
                        return e + "</tr>"
                ...
                if (b.includeLabels && (p += "<thead>" + n(j.header, "th", !0) + "</thead>"), p += "<tbody>", g.p.grouping) {
                    var
                        q = !!g.p.groupingView._locgr;
                    g.p.groupingView._locgr = !1, p += d(j.body), g.p.groupingView._locgr = q
                } else
                    for (var
                             i = 0, f = j.body.length; i < f; i++) p += o(j.body[i], "td", !0, 0 === i);
                if (b.includeFooter && g.p.footerrow && (j.footer = a(g).jqGrid("footerData", "get", null, !1), p += o(j.footer, "td", !1)), p += "</tbody>", p += "</table>", b.returnAsString) c = p; else {
                    var
                        r = window.open("", "");
                    r.document.close();
                    var
                        s = b.title ? "<title>" + b.title + "</title>" : "";
    ...
    $.jgrid.extend({
        sortableColumns: function (a) {
            return this.each(function () {
                ...
                var
                    j = a.sortable(g), k = j.data("sortable") || j.data("uiSortable");
            ...
            var
                e, f, g, h, i, j, k, l = this, m = {}, n = [], o = l.jqGrid("getGridParam", "colModel"),
            ...
            if (!$("#colchooser_" + $.jgrid.jqID(l[0].p.id)).length) {
                ...
                var
                    s = $(".ui-jqgrid").css("font-size") || "11px";
                                ...
                                accept: function (a) {
                                    ...
                                    if ($(c.draggable).hasClass("jqgrow")) {
                                        ...
                                        if (c.helper.dropped = !0, $.data(f[0], "dnd").beforedrop && $.isFunction($.data(f[0], "dnd").beforedrop)) {
                                            var
                                                n = $.data(f[0], "dnd").beforedrop.call(h, b, c, e, $(f[0]), $(h));
                                            void
